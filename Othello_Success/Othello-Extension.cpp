...
//候補として,盤面を変更するvoid関数に新たな引数であるbool型を追加する.通常の呼び出しの際は,bool simulation = false;であるが,
//TryBoardChanging関数を経由して,盤面を変更するvoid関数に辿り着いた際は,bool simulation = true;としておく.
//bool simulation = true;である場合は
...
if(Goal_Position != -1 && simulation == false) {
    ...
    return true;(ChangeStoneにtrueが渡される)
