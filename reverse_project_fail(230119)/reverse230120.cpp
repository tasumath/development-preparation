...
void board_change_line_vertical_to_up_White(int line_num,int row_num){
    cout<<"board_change_line_vertical_to_up_White関数を呼び出した"<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 1){
            while(line_kahen != -1){
                line_kahen--;
                if(board_number[line_kahen][row_kahen] == 1) break;
                if(board_number[line_kahen][row_kahen] == 0){
                    int line_kahen_edge = line_kahen;
                    while(line_kahen_edge != -1){
                        if(board_number[line_kahen][row_kahen] == 1){
                            hantei_1 = true;
                            break;
                        }
                        if(board_number[line_kahen][row_kahen] == 2){
                            hantei_2 = true;
                            break;
                        }
                        line_kahen_edge--;
                    ...
                    if(hantei_1){
                        for(int k = line_kahen; k>=line_kahen_edge;k--){
                            board_number[k][row_kahen] = 1;
                            board.PlacePiece(k,row_kahen,White);
                        }
                    }
                }
            }
...
void board_change_line_vertical_to_down_White(int line_num,int row_num){
    cout<<"board_change_line_vertical_to_down_White関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
...
void board_change_line_parallel_to_right_White(int line_num,int row_num){
    cout<<"board_change_line_parallel_to_right_White関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 1){
            while(row_kahen != 8){
                ...
                if(board_number[line_kahen][row_kahen] == 1) break;
                if(board_number[line_kahen][row_kahen] == 0){
                    int row_kahen_edge = row_kahen;
                    while(row_kahen_edge != 8){
                        if(board_number[line_kahen][row_kahen] == 1){
                            hantei_1 = true;
                            break;
                        }
                    ...
                    if(hantei_1){
                        for(int k = row_kahen; k<=row_kahen_edge;k++){
                            board_number[line_kahen][k] = 1;
                            board.PlacePiece(k,row_kahen,White);
                        }
                    }
                }
...
void board_change_line_parallel_to_left_White(int line_num,int row_num){
    cout<<"board_change_line_parallel_to_left_White関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    cout<<"line_kahen"<<line_kahen<<endl;
...
void board_change_cross_to_up_left_White(int line_num,int row_num){
    cout<<"board_change_cross_to_up_left_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 1){
            while(line_kahen != -1 && row_kahen != -1){
                ...
                /*/
                if(board_number[line_kahen][row_kahen] == 2){
                    board.PlacePiece(line_kahen + 1,row_kahen + 1,Black);
                    break;
                }
                /*/
            }
...
void board_change_cross_to_up_right_White(int line_num,int row_num){
    cout<<"board_change_cross_to_up_right_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
...
cout<<"board_change_cross_to_down_left_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
...
void board_change_cross_to_down_right_White(int line_num,int row_num){
    cout<<"board_change_cross_to_down_right_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    while(row_kahen != 8 && line_kahen != 8){
        int hantei_number = board_number[line_kahen][row_kahen];
        //cout<<"hantei_number"<<hantei_number<<endl;
        if(hantei_number == 1) board_cross.push_back(1);
        if(hantei_number == 0) board_cross.push_back(0);
...
void board_change_line_vertical_to_up_Black(int line_num,int row_num){
     cout<<"board_change_line_vertical_to_up_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
        ...
        if(hantei_number == 0){
            while(line_kahen != -1){
                ...
                if(board_number[line_kahen][row_kahen] == 1){
                    ...
                    cout<<line_kahen<<row_kahen<<endl;
                    board.PlacePiece(line_kahen + 1,row_kahen,Black);
                }
                /*/
                if(board_number[line_kahen][row_kahen] == 2){
                    board.PlacePiece(line_kahen + 1,row_kahen,White);
                    break;
                }
                /*/
            }
...
void board_change_line_vertical_to_down_Black(int line_num,int row_num){
     cout<<"board_change_line_vertical_to_down_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 0){
            while(line_kahen != 8){
                ...
                cout<<"line_kahen"<<line_kahen<<endl;
                cout<<"row_kahen"<<row_kahen<<endl;
                cout<<board_number[line_kahen][row_kahen]<<endl;
    ...
    while(! board_cross.empty()){
        board_cross.erase(board_cross.begin());
    }
}

void board_change_line_parallel_to_right_Black(int line_num,int row_num){
     cout<<"board_change_line_parallel_to_right_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 0){
            while(row_kahen != 8){
                ...
                /*/
                if(board_number[line_kahen][row_kahen] == 2){
                    board.PlacePiece(line_kahen,row_kahen - 1,White);
                    break;
                }
                /*/
            }
...
void board_change_line_parallel_to_left_Black(int line_num,int row_num){
    cout<<"board_change_line_parallel_to_left_Black関数を呼び出した"<<endl;
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    //cout<<"line_kahen"<<line_kahen<<endl;
    ...
    for(int i=0;i<(int)board_cross.size();i++){
        ...
        if(hantei_number == 0){
            while(line_kahen != -1 && row_kahen != -1){
                ...
                /*/
                if(board_number[line_kahen][row_kahen] == 2){
                    board.PlacePiece(line_kahen + 1,row_kahen + 1,White);
                    break;
                }
                /*/
            }
