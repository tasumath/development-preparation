...
void board_change_line_vertical_to_up_Black(line_number,row_number){

}
void board_change_line_vertical_to_down_Black(line_number,row_number){

}
void board_change_line_parallel_to_up_Black(line_number,row_number){

}
void board_change_line_parallel_to_down_Black(line_number,row_number){

}

void board_change_cross_to_up_left_Black(line_number,row_number){
...
void board_change_cross_to_up_right_Black(line_number,row_number){
    vector<int> board_cross;
    int line_kahen = line_num;
    int row_kahen = row_num;
    cout<<"line_kahen"<<line_kahen<<endl;
...
void board_change_cross_to_down_left_Black(line_number,row_number){

}

void board_change_cross_to_down_right_Black(line_number,row_number){
...
int main() {
    ...
    while(battle_pre){
        ...
        //(-1,-1)
        if(board_number[row_check][line_check] == 1){
