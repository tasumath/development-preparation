...
void board_change_cross_to_left_White(int line_num,int row_num){
    int board_cross[8];
    int line_kahen = 0;
    ...
    while(line_kahen != 8 || row_kahen != -1){
        ...
        if(line_kahen == 7 || row_kahen == 0) break;
        line_kahen++;
        row_kahen--;
        cross_num++;
    }
...
int main() {
    ...
    while(battle_pre){
        ...
        board_change_cross_to_left_White(line_number,row_number);
